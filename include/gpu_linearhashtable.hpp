...
struct gpu_linearhashtable {
  ...
  void insert(const key_slice_type* keys,
    ...
    kernels::GpuLinearHashtable::insert_device_func<gpu_linearhashtable, use_hash_tag, tag_use_same_hash, reuse_dirsize>
  ...
  void mixed_batch(const kernels::request_type* request_types,
    ...
    kernels::GpuLinearHashtable::mixed_device_func<gpu_linearhashtable, use_hash_tag, tag_use_same_hash, erase_do_merge_chains, erase_do_merge_buckets, reuse_dirsize>
